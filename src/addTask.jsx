        ...
        <div className="  flex-1">
            ...
            <div>
                <div className="flex flex-col w-full max-w-md p-3">
                    <input type="text" placeholder="Enter task title" value={title} className="border w-full p-2 ml-4" onChange={titleChange}/>
                    <textarea placeholder="Enter task description" className="border w-full h-80 p-2 m-4" value={content} onChange={contentChange}></textarea>
                    <button type="submit" className="bg-gray-700 m-4 w-full">Add Note</button>
                    <div className="flex gap-5 ml-5">
                        <div>
                        <input type="radio" id="high" name="priority" value="High" className="mr-2" onChange={priorityChange}/>
